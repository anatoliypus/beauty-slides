...
export const fonts = ['JetBrains Mono', 'Oswald', 'Merriweather', 'Open Sans', 'Roboto', 'Montserrat', 'Playfair Display', 'Lora', 'PT Serif', 'Russo One', 'Lobster', 'Amatic SC', 'Caveat', 'Yeseva One', 'Raleway'].sort();
WebFont.load({
    google: {
        families: fonts,
    },
